...
class Eqn_For_Species:
    """A full set of equation elements.""" 
    """This class should only be used when extracting species"""

    def __init__(self, reactants, products, *, str_orig=None, name=None):
        """
        reactants : list of (mult, spc) tuples
            to initialize `EqnElement`s
        products : " "
